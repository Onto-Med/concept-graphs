...
* initialize per-process RAG over document chunks, and
* answer questions using retrieved source snippets.[^readme]
...
4. **External integration layer**: [Storage](modules/storage.md), [RAG](modules/rag.md), and [query expansion](modules/query-expansion.md) adapt Marqo/vector stores and LLM/chat backends.
